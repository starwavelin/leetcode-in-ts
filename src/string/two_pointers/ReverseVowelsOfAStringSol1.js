...
/**
 * Note: 1. In JS, the string type is immutable, so use strArr to manipulate the swap and then 
 set strArr back to string (use strArr.join(''))
 2. Upper case letters should be considered as vowels too.
 3. JS doesn't have ArryIndexOutOfBound Exception!!
 */
